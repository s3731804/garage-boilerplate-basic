...
export default function SignInPage() {
  ...
  return (
    <div className="container d-flex min-vh-100" style={{ top : '50%', transform: 'translateY(-40%)' }}>
      <div className="row">
        <div className="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
          {/* card to have a popout with dark shadow and very rounded corners */}
          <div className="card w-90 rounded-3xl border border-zinc-200 bg-white shadow-xl fs-3">
            <div className="card-body p-7 space-y-4">
              <div className="space-y-1 text-left">
                <h1 className="text-2xl font-bold tracking-tight zinc">Welcome back!</h1>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-zinc-50 px-2 text-zinc-400"></span>
                </div>
              </div>
